  ...
  return (
    <footer className="border-t border-border bg-white">
      <div className="max-w-5xl mx-auto px-6 md:px-10 py-7 flex flex-col items-center justify-between gap-3">
        <p className="text-md text-gray-800 letter-spacing-[0.02em] text-align:center font-body">
          ...
          More info in the <a href="https://github.com/dgattoni/nextjs-sanity-web" target="_blank"
            className="text-pink-800 hover:underline">Readme file of my GitHub repository.</a>
        </p>
        <p className="text-md text-gray-800 letter-spacing-[0.02em] text-align:center mt-5 font-body">
